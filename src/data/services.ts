    ...
    useCases: [
      {
        ...
        gradient: "linear-gradient(135deg, rgba(235,115,0,0.25) 0%, rgba(0,21,36,0.95) 100%)",
      },
      {
        title: "Social Media Videos",
        desc: "Scroll-stopping short-form content engineered for reels, TikTok, and stories.",
        gradient: "linear-gradient(135deg, rgba(100,80,200,0.25) 0%, rgba(0,21,36,0.95) 100%)",
      },
      {
        title: "Explainer Videos",
        desc: "Clear, compelling animations that communicate complex products in under 90 seconds.",
        gradient: "linear-gradient(135deg, rgba(0,180,150,0.2) 0%, rgba(0,21,36,0.95) 100%)",
      },
      {
        title: "Product Launch Campaigns",
        desc: "Multi-format launch content that builds hype before day one and converts after.",
        gradient: "linear-gradient(135deg, rgba(235,50,100,0.2) 0%, rgba(0,21,36,0.95) 100%)",
      },
    ],
