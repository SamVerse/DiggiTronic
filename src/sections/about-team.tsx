...
import { getYouTubeSubscribers } from "@/actions/youtube";
...
export default function AboutTeam() {
  ...
  const [youtubeCount, setYoutubeCount] = useState("2.3K+");

  useEffect(() => {
    getYouTubeSubscribers().then(setYoutubeCount);
  }, []);
